...
class App:
    ...
    def __init__(self, size: tuple[int, int] = (640 * 2, 480 * 2)) -> None:
    ...
    def change_scene(self, scene_type) -> None:
        ...
        :param scene_type: the scene-type to be constructed. 
                           ...
                           and take a pygame_gui.UIManager as a parameter in it's constructor.
        """
        self.scene = scene_type(self.ui_manager)
    ...
    def exec(self) -> None:
        ...
        while also measuring delta_time between each frame.
        """
